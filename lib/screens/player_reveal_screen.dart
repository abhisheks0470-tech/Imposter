...
List<_SecretWord> _wordsForCategory(CategoryOption category) {
  return switch (category) {
    ...
    CategoryOption.custom => _wordList(category, Icons.shuffle_rounded, const [
      ('गुलाब', 'Rose'),
      ('गुब्बारा', 'Balloon'),
      ('बस', 'Bus'),
      ('छाता', 'Umbrella'),
      ...
      ('किला', 'Fort'),
      ('समुद्र तट', 'Beach'),
      ('जन्मदिन केक', 'Birthday Cake'),
      ('आइसक्रीम कोन', 'Ice Cream Cone'),
      ('पिज़्ज़ा स्लाइस', 'Pizza Slice'),
      ('चॉकलेट बार', 'Chocolate Bar'),
      ('पॉपकॉर्न बाल्टी', 'Popcorn Bucket'),
      ('गिफ्ट बॉक्स', 'Gift Box'),
      ('दीवाली दीया', 'Diwali Lamp'),
      ('होली पिचकारी', 'Water Gun'),
      ('पतंग', 'Kite'),
      ('झूला', 'Swing'),
      ('सूटकेस', 'Suitcase'),
      ('कचरा डिब्बा', 'Trash Bin'),
    ]),
  };
}
